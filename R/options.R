...
#'
#' An options manager for configuring lentil model parameters. This object provides
#' methods to get and set lentil related parameters.
#'
...
#' @return An option manager object for configuring lentil model parameters.
#' @examples
...
#' # Reset to defaults
#' lentil$reset()
lentil <- optree::create_options_manager(
    defaults = list(
        phenology = list(
            thermal_time = list(
                x = c(0, 28, 35),
