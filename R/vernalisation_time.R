...
#' [APSIM Next Generation lentil Documentation](https://apsimng-notes.bangyou.me/docs/Plants/lentil/Phenology/Vegetative.html).
#' 
#' 
#' @param mint The minimum temperature
#' @param maxt The maximum temperature
#' @param x_temp The cardinal temperatures used to calculate vernalisation time. The default values are defined in lentil$get("phenology.vernalisation_time.x").
#' @param y_temp The effective vernalisation time at the corresponding cardinal temperatures. The default values are defined in lentil$get("phenology.vernalisation_time.y").
